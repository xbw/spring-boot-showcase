package com.spring.boot.beetl;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.spring.boot.project.model.User;
import com.spring.boot.project.multiple.UserSecondaryMapper;
import com.spring.boot.project.multiple.UserSecondaryService;
...
@SpringBootTest
class BeetlSqlMultiTests {

    @Autowired
    @Qualifier("secondarySqlManager")
    SQLManager sqlManager;
    @Autowired
    private UserSecondaryService userService;
    @Autowired
    private UserSecondaryMapper userMapper;
