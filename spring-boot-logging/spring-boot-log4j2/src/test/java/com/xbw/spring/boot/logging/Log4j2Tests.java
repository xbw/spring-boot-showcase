...
public class Log4j2Tests {
    ...
    void slf4j() {
        ...
        Assertions.assertEquals(org.apache.logging.slf4j.Log4jLogger.class, logger.getClass());
    ...
    void log4j2() {
        ...
        Assertions.assertEquals(org.apache.logging.log4j.core.Logger.class, logger.getClass());
...
//        Assertions.assertEquals("org.apache.logging.log4j.jcl.Log4jLog", logger.getClass().getName());
        Assertions.assertEquals("org.apache.commons.logging.LogAdapter$Log4jLog", logger.getClass().getName());
        if (logger.isFatalEnabled()) {
            logger.fatal("fatal");
        }
        if (logger.isErrorEnabled()) {
