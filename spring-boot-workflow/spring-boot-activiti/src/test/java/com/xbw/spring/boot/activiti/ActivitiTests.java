...
class ActivitiTests {
    ...
    public final static String PROCESS_DEFINITION_ID = "oneTaskProcess:1:5003";
    public final static String PROCESS_INSTANCE_ID = "10001";
    public final static String TASK_ID = "10004";
