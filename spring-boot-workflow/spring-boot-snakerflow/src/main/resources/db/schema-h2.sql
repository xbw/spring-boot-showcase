alter table if exists wf_order drop constraint FK_ORDER_PARENTID;
alter table if exists wf_order drop constraint FK_ORDER_PROCESSID ;
alter table if exists wf_task_actor drop constraint FK_TASK_ACTOR_TASKID;
alter table if exists wf_task drop constraint FK_TASK_ORDERID;
alter table if exists wf_hist_order drop constraint FK_HIST_ORDER_PARENTID;
alter table if exists wf_hist_order drop constraint FK_HIST_ORDER_PROCESSID;
alter table if exists wf_hist_task drop constraint FK_HIST_TASK_ORDERID;
alter table if exists wf_hist_task_actor drop constraint FK_HIST_TASKACTOR;
