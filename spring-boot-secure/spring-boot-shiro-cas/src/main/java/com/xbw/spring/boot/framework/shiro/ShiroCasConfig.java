...
import com.xbw.spring.boot.framework.shiro.filter.CasFilter;
import com.xbw.spring.boot.framework.shiro.realm.CasRealm;
...
public class ShiroCasConfig extends AbstractShiroWebConfiguration {
    ...
    public ShiroFilterChainDefinition shiroFilterChainDefinition() {
        ...
        chainDefinition.addPathDefinition("/login", "cas");
